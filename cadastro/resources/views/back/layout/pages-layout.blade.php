...
<html>
	<head>
		...
		<link
			...
			sizes="180x180"
			href="/back/vendors/images/favicon-univasf.ico"
		/>
		<link
			rel="icon"
			type="image/ico"
		...
		<div class="pre-loader">
			<div class="pre-loader-box">
				<div class="loader-logo">
					<img src="/back/vendors/images/sead.png" alt="" />
				</div>
					...
					<div class="dropdown">
						...
						>
							...
							<a class="dropdown-item" href="faq.html"
								><i class="dw dw-help"></i> Help</a
							>
							<a class="dropdown-item" href="{{ route('servidor.logout_handler') }}"
								onclick="event.preventDefault();document.getElementById('servidorLogoutForm').
								submit();"><i class="dw dw-logout"></i> Log Out</a
							>
							<form action="{{ route('servidor.logout_handler') }}" id="servidorLogoutForm"
							method="POST">@csrf</form>
						</div>
					</div>
				</div>
					...
					<div class="dropdown">
						...
						>
							...
							<a class="dropdown-item" href="faq.html"
								><i class="dw dw-help"></i> Help</a
							>
							<a class="dropdown-item" href="{{ route('candidato.logout_handler') }}"
								onclick="event.preventDefault();document.getElementById('candidatoLogoutForm').
								submit();"><i class="dw dw-logout"></i> Log Out</a
							>
							<form action="{{ route('candidato.logout_handler') }}" id="candidatoLogoutForm"
							method="POST">@csrf</form>
						</div>
					</div>
				</div>
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="home">
					...
					<img
						src="/back/vendors/images/logo_sead.png"
						alt=""
						class="light-logo"
					/>
				</a>
