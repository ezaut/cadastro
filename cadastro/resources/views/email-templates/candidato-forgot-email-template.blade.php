...
<p>
    We are received a request to reset the password for account associated with {{ $candidato->email }}.
    ...
    <br>
    If you did request for a password reset, please ignore this email.
</p>
